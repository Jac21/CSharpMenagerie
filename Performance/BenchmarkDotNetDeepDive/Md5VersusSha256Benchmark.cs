...
{
    [Config(typeof(Config))] // Using percentiles for adequate timings representation
    [SimpleJob(RunStrategy.Throughput, targetCount: 10, launchCount: 3, warmupCount: 3,
        id: "MyJob")] // set run strategy
