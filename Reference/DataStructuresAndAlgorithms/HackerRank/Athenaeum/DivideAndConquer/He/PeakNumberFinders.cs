...
namespace Athenaeum.DivideAndConquer.He
{
    public class PeakNumberFinders
    {
        public static void Main()
        {
            var oneDimensionalResult = FindPeakElement(new[] {1, 2, 3, 2, 1, 4});

            Console.WriteLine(oneDimensionalResult);

            var twoDimensionalResult =
                FindPeakElement2D(new[] {new[] {10, 20, 30}, new[] {15, 32, 17}, new[] {21, 16, 35}});

            Console.WriteLine(twoDimensionalResult);
        }
